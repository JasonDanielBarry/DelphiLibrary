...
procedure TTestMatrixMethods.TestDeterminant();
var
...
begin
    //2 x 2
        ...
        actual := matrixDeterminant(testMatrix);
        expected := -2;
...
procedure TTestMatrixMethods.Test2(const AValue1 : Integer;const AValue2 : Integer);
begin
end;
